    ...
    centerPanel.innerHTML = `
        <article class="intro-content about-me-article">
            <div class="about-me-content">
                ...
                <p>Almost from birth, I've lived across different countries, cultures, and languages. That mix taught me to understand before I speak. But it came with its own challenges. I ended up as a late talker. It took me a long time to find words that landed, to turn what was in my head into something someone else could understand.  Looking back, that's where I first started doing the thing I still do for a living: carrying meaning from one side of a gap to the other.</p>
